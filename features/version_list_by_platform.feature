Feature: Version List by Platform
  ...
  Background:
    ...
    And the Versions
      ...
      | java      | 8u131   | open   | MAC_OSX    | http://download.oracle.com/otn-pub/java/jdk/8u131-b14/jdk-8u131-osx-x64.tar.gz            |
      | java      | 9ea163  | open   | MAC_OSX    | http://download.java.net/java/jdk9/archive/163/binaries/jdk-9-ea+163_osx-x64_bin.tar.gz   |
      | java      | 8u111   | open   | WINDOWS_64 | http://download.oracle.com/otn-pub/java/jdk/8u111-b14/jdk-8u111-windows-x64.tar.gz        |
      | java      | 8u121   | open   | WINDOWS_64 | http://download.oracle.com/otn-pub/java/jdk/8u121-b14/jdk-8u121-windows-x64.tar.gz        |
      | scala     | 2.12.6  | open   | UNIVERSAL  | http://dl/scala/2.12.0/scala-2.12.0.zip                                                   |
