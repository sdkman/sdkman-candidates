...
class PlatformSpec extends WordSpec with Matchers {
  "platform" should {
    "return some platform identifier when presented with a valid unnormalised uname" in {
      ...
      Platform("MINGW64_NT-6.1") shouldBe None
      Platform("MINGW64_NT-6.3") shouldBe None
      Platform("MINGW64_NT-10.0") shouldBe None
      Platform("MSYS_NT-6.1") shouldBe None
      Platform("MSYS_NT-6.3") shouldBe None
      Platform("MSYS_NT-10.0") shouldBe None
